...
public class ProcessGPClaimProcessor extends MessageProcessor implements MessageListener
{
	...
	public ProcessGPClaimProcessor(Session session)
	{
		super(session);
	}
	...
	public void onMessage(Message message)
	{
		...
		try {
			...
			logError("ProcessGPClaimProcessor.onMessage() " + ex.getMessage(), ex);
		}
	}
}
