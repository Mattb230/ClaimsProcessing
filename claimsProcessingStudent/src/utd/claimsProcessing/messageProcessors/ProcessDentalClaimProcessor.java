...
public class ProcessDentalClaimProcessor extends MessageProcessor implements MessageListener
{
	...
	public ProcessDentalClaimProcessor(Session session)
	{
		super(session);
	}
	...
	public void onMessage(Message message)
	{
		...
		try {
			...
			logError("ProcessDentalClaimProcessor.onMessage() " + ex.getMessage(), ex);
		}
	}
}
